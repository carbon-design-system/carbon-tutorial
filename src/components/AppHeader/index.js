...
import { Header, HeaderGlobalBar } from 'carbon-components-react';

const AppHeader = () => {
  // const userEmail = useSelector((state) => state.user.userDetails.emailAddress);
  return (
    <Header aria-label="IBM Platform Name">
      <div id="ibm-home">
        <a href="http://www.ibm.com/?lnk=m">
          <svg
            width="58"
            height="23"
            viewBox="0 0 58 23"
      ...
      {/* <HeaderNavigation aria-label="IBM [Platform]">
                <HeaderMenuItem>
                <Link to="/registration" className='links'>Registration Form</Link>
                </HeaderMenuItem>
                <HeaderMenuItem>
                    <Link to="/myrequests" className='links'>My Requests</Link>
                </HeaderMenuItem>
            </HeaderNavigation> */}
      <HeaderGlobalBar>
        {/* <div className="user-avatar">
          {userEmail ? (
            <img
              className="user-avatar__user-img"
              src={env.userAvatarBaseUrl + userEmail}
              width="30"
              height="30"
              alt=""
            />
