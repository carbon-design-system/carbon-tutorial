    ...
    <div className="bx--grid bx--grid--full-width landing-page">
      ...
      <InfoSection heading={'The Principles'} className={'landing-page__r3'}>
        <InfoCard
          ...
          body={
            "It's a distributed effort, guided by the principles of the open-source movement. " +
        ...
        <InfoCard
          ...
          body="Carbon's modularity ensures maximum flexibility in execution. It's components are
						  designed to work seamlessly with each other, in whichever combination suits the needs of the user."
          icon={<Application32 />}
        />
        <InfoCard
